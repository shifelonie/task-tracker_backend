import { BaseLiteralType } from '@vinejs/vine/schema/base/literal';
import { IS_OF_TYPE, UNIQUE_NAME } from '../../symbols.js';
import type { Validation, AlphaOptions, FieldContext, FieldOptions, AlphaNumericOptions, NormalizeEmailOptions } from '@vinejs/vine/types';
...
export declare class VineString extends BaseLiteralType<string, string, string> {
    static rules: {
        ...
        mobile: (options?: import("@vinejs/vine/types").MobileOptions | ((field: FieldContext) => import("@vinejs/vine/types").MobileOptions | undefined) | undefined) => Validation<import("@vinejs/vine/types").MobileOptions | ((field: FieldContext) => import("@vinejs/vine/types").MobileOptions | undefined) | undefined>;
        string: (options?: undefined) => Validation<undefined>;
        hexCode: (options?: undefined) => Validation<undefined>;
        passport: (options: import("@vinejs/vine/types").PassportOptions | ((field: FieldContext) => import("@vinejs/vine/types").PassportOptions)) => Validation<import("@vinejs/vine/types").PassportOptions | ((field: FieldContext) => import("@vinejs/vine/types").PassportOptions)>;
        endsWith: (options: {
            substring: string;
        }) => Validation<{
            substring: string;
        ...
        creditCard: (options?: import("@vinejs/vine/types").CreditCardOptions | ((field: FieldContext) => void | import("@vinejs/vine/types").CreditCardOptions | undefined) | undefined) => Validation<import("@vinejs/vine/types").CreditCardOptions | ((field: FieldContext) => void | import("@vinejs/vine/types").CreditCardOptions | undefined) | undefined>;
        postalCode: (options?: import("@vinejs/vine/types").PostalCodeOptions | ((field: FieldContext) => void | import("@vinejs/vine/types").PostalCodeOptions | undefined) | undefined) => Validation<import("@vinejs/vine/types").PostalCodeOptions | ((field: FieldContext) => void | import("@vinejs/vine/types").PostalCodeOptions | undefined) | undefined>;
        startsWith: (options: {
            substring: string;
        }) => Validation<{
            substring: string;
